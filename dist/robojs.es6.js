...
$__System.registerDynamic("2a", ["7", "29", "13"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var _curry2 = $__require('7');
  var _reduced = $__require('29');
  var _xfBase = $__require('13');
  module.exports = (function() {
    function XFind(f, xf) {
      this.xf = xf;
...
$__System.registerDynamic("2b", ["7", "18", "2a"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("18", ["20", "2c", "21"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("30", ["15", "7"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("19", ["2f", "30", "f"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var _xwrap = $__require('2f');
  var bind = $__require('30');
  var isArrayLike = $__require('f');
  module.exports = (function() {
...
$__System.registerDynamic("31", ["7", "13"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("1a", ["10", "32", "33"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("c", ["7", "18", "2d", "2e", "19", "31", "1a"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var _curry2 = $__require('7');
  var _dispatchable = $__require('18');
  var _filter = $__require('2d');
  var _isObject = $__require('2e');
  var _reduce = $__require('19');
  var _xfilter = $__require('31');
  var keys = $__require('1a');
...
$__System.register("34", ["4", "2b", "c"], function($__export) {
  "use strict";
  var EventDispatcher,
      find,
      filter;
...
$__System.register("35", ["8", "27", "28", "34"], function($__export) {
  "use strict";
...
$__System.register("1", ["28", "2", "4", "d", "27", "8", "3", "35"], function($__export) {
  "use strict";
  var sl,
      amdl,
      ed,
